...
%    The ZFi effect is represented as purely competitive without
%    affecting cooperative RNAPII recruitment.


function sim = model_ZFa_ZFi_competitive(doseZFa, doseZFi, m, wA, wI, b, Z)
...
%    Competitive inhibition without loss of cooperativity corresponds to
%        the scenario of a compact promoter and a ZFi.

%Example for ZF1a and the c'th cell in a heterogeneous population:
%    sim = model_ZFa_ZFi_competitive(50, 50, 32.7, 0.036, 0.036, 0.08, Z(c, :));

%Example for a homogeneous simulation:
%    sim = model_ZFa_ZFi_competitive(50, 50, 32.7, 0.036, 0.036, 0.08, [1, 1, 1]);
